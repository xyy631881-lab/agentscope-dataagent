...
export default function AiDescribeForm({ available, draft, onDraft }: Props) {
  ...
  async function handleDraft() {
    ...
    try {
      ...
      setErr(e instanceof Error ? e.message : '草稿生成失败');
    } finally {
      setBusy(false);
    }
  }
  ...
  return (
    <div style={S.root}>
      <textarea
        ...
        placeholder="描述你希望这个 agent 做什么。例如：'一个研究助手，可以读取我们的 /docs 文件夹并总结问题的答案，附带引用。'"
      />
      <button
