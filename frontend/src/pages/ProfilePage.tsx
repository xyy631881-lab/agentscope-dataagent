    ...
    <>
      <div style={S.page}>
        ...
        <div style={S.grid}>
          ...
          {/* Account card */}
          <div style={S.card}>
            <span style={S.cardLabel}>账户</span>
            {profile && (
              <>
                <div style={S.row}>
          ...
          <div style={S.card}>
            ...
            {usage ? (
              <>
                ...
                {daily.length > 0 && (
                  <>
                    <div style={{ fontSize: '0.7rem', color: '#4b5280', marginBottom: 4 }}>最近 7 天</div>
                    <Sparkline data={daily} />
                  </>
                )}
              </>
            ) : (
              <div style={{ color: '#4b5280', fontSize: '0.8rem' }}>暂无用量数据。</div>
            )}
          </div>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
            ...
            <div>
              ...
              <input style={S.input} type="password" value={newPwd}
                onChange={e => setNewPwd(e.target.value)} placeholder="至少 6 个字符" />
            </div>
            <div>
              <label style={S.fieldLabel}>确认新密码</label>
              <input style={S.input} type="password" value={conPwd}
                onChange={e => setConPwd(e.target.value)} placeholder="重复密码" />
            </div>
          </div>
