  ...
  return (
    <>
      <AdminPageLayout
        ...
        bannerRight={
          tab === 'info'
            ? <button style={S.refreshBtn} onClick={loadInfo}>↺ 刷新</button>
            : undefined
        }
      >
          ...
          {tab === 'logs' && (
            <>
              <div style={S.logHeader}>
                <button style={S.clearBtn} onClick={() => setLogs([])}>清除</button>
                <button
                  style={{
                    ...S.streamBtn,
