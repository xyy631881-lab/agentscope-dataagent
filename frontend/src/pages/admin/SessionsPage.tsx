      ...
      <div style={S.page}>
        ...
        <div style={S.toolbar}>
          ...
          <span style={{ fontSize: '0.88rem', color: '#64748b', marginLeft: 'auto' }}>
            {displayed.length} / {sessions.length} 个会话
          </span>
        </div>
          ...
          <tbody>
            {displayed.map(s => (
              <tr key={s.sessionKey}>
                ...
                <td style={S.td}>
                  <button style={S.viewBtn} onClick={() => openTree(s.sessionKey)}>树</button>
                </td>
              </tr>
            ))}
          </tbody>
        ...
        {!loading && displayed.length === 0 && (
          <p style={{ color: '#94a3b8', fontSize: '0.92rem', marginTop: 20 }}>未找到会话。</p>
        )}
      </div>
        ...
        <div style={S.modal} onClick={() => setViewKey(null)}>
          <div style={S.modalBox} onClick={e => e.stopPropagation()}>
            ...
            <div style={S.modalBody}>
              {modalTab === 'tree' && (
                <>
                  {treeLoading && <p style={{ color: '#64748b' }}>加载中…</p>}
              ...
              {modalTab === 'workspace' && (
                <>
                  {eventsLoading && <p style={{ color: '#64748b' }}>加载中…</p>}
