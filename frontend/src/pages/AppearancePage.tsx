    ...
    <>
      <div style={S.content}>
        ...
        <div style={S.section}>
          ...
          <div style={S.row}>
            <div>
              ...
              <div style={S.sub}>用于按钮、激活状态和高亮</div>
            </div>
            <input
              type="color"
              style={S.colorInput}
          ...
          <div style={S.row}>
            <div>
              ...
              <div style={S.sub}>减少内边距和消息气泡大小</div>
            </div>
        ...
        <div style={S.section}>
          ...
          <div>
            <div style={{ ...S.label, marginBottom: 8 }}>欢迎消息</div>
            <div style={S.sub}>未选择 agent 时在聊天页面显示</div>
            <textarea
              style={{
                ...S.input,
                width: '100%',
        ...
        <div style={S.section}>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'center' }}>
            <button style={{ ...S.saveBtn, background: settings.accentColor }}>主要按钮</button>
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginTop: 8 }}>
          ...
          <button style={S.resetBtn} onClick={reset}>重置为默认</button>
