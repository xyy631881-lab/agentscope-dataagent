...
import io.agentscope.dataagent.DataAgentApp;
...
import io.agentscope.dataagent.agent.domain.UserAgentDefinitionStore.StoredEntry;
...
@TestPropertySource(
        properties = {
            ...
            "dataagent.workspace=${java.io.tmpdir}/agentscope-dataagent-jpa-it",
