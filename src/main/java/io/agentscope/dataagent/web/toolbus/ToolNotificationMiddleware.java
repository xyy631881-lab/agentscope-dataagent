 ...
 *
 * <p><strong>TODO (2.0 upgrade):</strong> With the unified {@code Flux<AgentEvent>} event
 * stream from {@code dispatchStream()}, the ChatController SSE already carries
 * {@code tool_call}/{@code tool_result} events. Once the frontend switches to consuming
 * tool events exclusively from the main SSE stream, this middleware and
 * {@link ToolEventBus} can be removed.</p> */
