...
import io.agentscope.dataagent.security.api.AdminUserController;
import io.agentscope.dataagent.security.infrastructure.UserEntity;
 ...
 * {@link io.agentscope.dataagent.security.api.AdminUserController#delete} flow takes responsibility
...
@Entity
@Table(
        name = "dataagent_agent",
        uniqueConstraints =
                @UniqueConstraint(
                        name = "ux_dataagent_agent_owner_agent",
                        columnNames = {"owner_id", "agent_id"}),
        indexes = {
            @Index(name = "ix_dataagent_agent_owner", columnList = "owner_id"),
            @Index(name = "ix_dataagent_agent_agent_id", columnList = "agent_id")
        })
public class AgentEntity {
     ...
     * See {@link io.agentscope.dataagent.workspace.infrastructure.WorkspaceManagerFactory#resolveAgentDataPath}
    ...
    /**
     * JSON-serialised {@link io.agentscope.dataagent.runtime.config.SkillRepositoryConfigEntry} list
