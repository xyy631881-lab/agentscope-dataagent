 ...
 */
package io.agentscope.dataagent.integration.outbound.domain;
...
/**
 * 面向 Agent 的主动出站投递工具，可将消息投递到任何已注册的 channel（DingTalk、WeCom 等）。
 * 由 {@link io.agentscope.dataagent.runtime.DataAgentBootstrap} 注册到主 Agent 的工具包中。
 *
 * <p>Agent 提供目标（{@code channel_id} + {@code peer_kind} + {@code peer_id}）
 * 以及 {@code text} 或 {@code markdown}。工具返回简短的状态字符串。
 */
