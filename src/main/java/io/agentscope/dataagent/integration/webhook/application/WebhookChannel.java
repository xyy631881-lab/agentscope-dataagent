 ...
 */
package io.agentscope.dataagent.integration.webhook.application;
import io.agentscope.dataagent.integration.webhook.api.WebhookCallbackController;
import io.agentscope.dataagent.integration.webhook.domain.WebhookChannelProperties;
import io.agentscope.dataagent.integration.webhook.domain.WebhookInboundRequest;
import io.agentscope.dataagent.integration.webhook.infrastructure.WebhookInboundMapper;
import io.agentscope.dataagent.integration.webhook.infrastructure.WebhookOutboundClient;
...
public final class WebhookChannel implements Channel {
    ...
    public WebhookChannelProperties properties() {
        return properties;
    }
